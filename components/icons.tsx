...
export const StethoscopeIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 10h2a8 8 0 018 8v2M3 10V6a3 3 0 013-3h1m4 4v1m-5 10v-5a2 2 0 012-2h2a2 2 0 012 2v5m-5 0h-2a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2z" />
    </svg>
);
...
export const HeartPulseIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 10.5H9l1.5 3 1.5-6 1.5 3H15" />
    </svg>
);

export const SkullIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a8.25 8.25 0 01-6.525-3.415C4.625 16.275 4.5 14.7 4.5 12.75V11.25c0-1.5 1.125-2.25 2.25-2.25h10.5c1.125 0 2.25.75 2.25 2.25v1.5c0 1.95-.125 3.525-1.025 4.835A8.25 8.25 0 0112 21zM9.75 12.75a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zm6 0a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
...
export const LightBulbIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311a6.01 6.01 0 00-3.75 0M3.75 12h16.5M12 3v1.875m-3.75 2.311L6 6.875m12 0l-2.25 2.25M3.75 12a8.25 8.25 0 0116.5 0H3.75z" />
    </svg>
);
...
export const FolderOpenIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5h3.75m-3.75 0V8.25m0 0h3.75m-3.75 0L15 12l-1.5-1.5m-3.75 3.75-1.5 1.5m0 0l-3.75-3.75M9.75 12l1.5-1.5m-1.5 1.5l1.5 1.5m-3.75 3.75l1.5 1.5m-1.5-1.5L5.25 12l1.5-1.5m3.75 3.75m-1.5-1.5l1.5-1.5" />
    </svg>
);